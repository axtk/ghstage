export function getIcon(baseColor = 'gray') {
    return `
        ...
        <style>g{--b:${baseColor};--c:color(from var(--b) calc(100*(.78 - l)) 0 0);}.b{fill:var(--b);}.c0{fill:color(from var(--c) srgb r g b / .5);}.c1{fill:color(from var(--c) srgb r g b / .3);}.c2{fill:none;}</style>
        <g stroke="none">
